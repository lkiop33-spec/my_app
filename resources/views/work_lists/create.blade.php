                ...
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('work_lists.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="pcbIDX" name="pcbIDX" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('pcbIDX', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="memberIDX" value="memberIDX" class="text-gray-300" />
                            <x-text-input id="memberIDX" name="memberIDX" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('memberIDX', '') }}" />
                        </div>
