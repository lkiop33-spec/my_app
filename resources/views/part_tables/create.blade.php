        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('part_tables.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="Part_Number" name="Part_Number" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Part_Number', '') }}" />
                        </div>
                        ...
                        <div>
                            ...
                            <select id="PCB_Number" name="PCB_Number" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                @foreach($pcbs as $pcb)
                                    <option value="{{ $pcb->idx }}" {{ old('PCB_Number', '') == $pcb->idx ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <x-text-input id="Process_Class" name="Process_Class" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Process_Class', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Process_Name" value="Process Name" class="text-gray-300" />
                            <x-text-input id="Process_Name" name="Process_Name" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Process_Name', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Process_Detail" value="Process Detail" class="text-gray-300" />
                            <x-text-input id="Process_Detail" name="Process_Detail" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Process_Detail', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Side" value="Side" class="text-gray-300" />
                            <x-text-input id="Side" name="Side" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Side', '') }}" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="Quantity" name="Quantity" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Quantity', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Location_1" value="Location 1" class="text-gray-300" />
                            <x-text-input id="Location_1" name="Location_1" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Location_1', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Location_2" value="Location 2" class="text-gray-300" />
                            <x-text-input id="Location_2" name="Location_2" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Location_2', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Location_3" value="Location 3" class="text-gray-300" />
                            <x-text-input id="Location_3" name="Location_3" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Location_3', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Location_4" value="Location 4" class="text-gray-300" />
                            <x-text-input id="Location_4" name="Location_4" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Location_4', '') }}" />
                        </div>
