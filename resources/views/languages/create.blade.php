        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('languages.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="mlanguage" name="mlanguage" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('mlanguage', '') }}" />
                        </div>
