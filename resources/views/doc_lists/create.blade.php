        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('doc_lists.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="filename" name="filename" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('filename', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="path" value="path" class="text-gray-300" />
                            <x-text-input id="path" name="path" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('path', '') }}" />
                        </div>
