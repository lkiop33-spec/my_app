        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('pcb_image_tables.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="Image" name="Image" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Image', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="BoundBox" value="BoundBox" class="text-gray-300" />
                            <x-text-input id="BoundBox" name="BoundBox" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('BoundBox', '') }}" />
                        </div>
                        
                        <div>
                            <x-input-label for="Other" value="Other" class="text-gray-300" />
                            <x-text-input id="Other" name="Other" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('Other', '') }}" />
                        </div>
