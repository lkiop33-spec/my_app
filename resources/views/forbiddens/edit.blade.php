        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('forbiddens.update', $forbidden->idx ?? $forbidden->id) }}" class="space-y-6">
                        @csrf
                        @method("PUT")
                        ...
                        <div>
                            ...
                            <x-text-input id="text" name="text" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" value="{{ old('text', $forbidden->text) }}" />
                        </div>
